...
- Algunos registros presentan valores nulos en `net_weight_kg`, por lo que no es posible calcular `avg_price_usd_kg`.
- Estos registros se conservan para los análisis basados en valor de importación.
- El año 2025 se excluye del dataset final enriquecido porque World Bank no dispone todavía de datos de población y PIB per cápita para ese periodo.