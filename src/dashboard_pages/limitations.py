...
def render_limitations():
    ...
    <div class="section-card">
        ...
        <ul>
            <li>Mezclas de productos.</li>
            <li>Diferentes grados de transformación.</li>
            <li>Distintas cadenas de suministro.</li>
            <li>Efectos de inflación o tipo de cambio.</li>
        </ul>
    </div>
    """,
    unsafe_allow_html=True
    ...
    <div class="section-card">
        ...
        la expansión internacional de Velluto.
